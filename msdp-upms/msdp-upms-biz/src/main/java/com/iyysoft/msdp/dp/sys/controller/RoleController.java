...
import com.iyysoft.msdp.dp.sys.service.SysRoleMenuService;
...
public class RoleController {
    ...
    @ApiOperation(value = "根据code值查询当前角色")
    public R<SysRole> findRolebyCode(@PathVariable String code) {
        return new R<>(sysRoleService.getOne(Wrappers.<SysRole>query().lambda().eq(SysRole::getRoleCode, code)));
    }
}
