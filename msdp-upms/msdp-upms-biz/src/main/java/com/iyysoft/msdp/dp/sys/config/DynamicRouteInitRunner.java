package com.iyysoft.msdp.dp.sys.config;
...
import com.iyysoft.msdp.common.gateway.support.DynamicRouteInitEvent;
...
public class DynamicRouteInitRunner {
    ...
    public void initRoute() {
        ...
        routeConfService.routes().forEach(route -> {
            ...
            msdpRedisTemplate.opsForHash().put(CommonConstants.ROUTE_KEY, route.getRouteId(), vo);
        });
        log.debug("初始化网关路由结束 ");
    }
