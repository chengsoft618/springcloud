...
public class WebUtils extends org.springframework.web.util.WebUtils {
    ...
    private final String HEAD_FROM_ID = "msdpfrom";
     ...
     */
    @SneakyThrows
    public String[] getFromId(ServerHttpRequest request) {
        String header = request.getHeaders().getFirst(HEAD_FROM_ID);
        if (header == null) return new String[]{"", ""};
        ;
