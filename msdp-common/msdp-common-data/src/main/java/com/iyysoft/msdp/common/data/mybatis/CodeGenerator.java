...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://119.3.111.107:9306/jtg-worker-manage-user");
        dataSourceConfig.setDbType(DbType.MYSQL);
        dataSourceConfig.setSchemaName("jtg-worker-manage-user");
        dataSourceConfig.setDriverName("com.mysql.cj.jdbc.Driver");
        dataSourceConfig.setUsername("ms_app");
        dataSourceConfig.setPassword("base.C1app");
        mpg.setDataSource(dataSourceConfig);

        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setParent("com.iyysoft.msdp.dp.app");
      ...
      //  TemplateConfig templateConfig = new TemplateConfig();
       ...
       // strategy.setSuperEntityClass("com.qyb.demo.model.BaseEntity");
