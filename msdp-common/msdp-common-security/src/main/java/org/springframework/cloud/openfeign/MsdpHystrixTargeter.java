...
class MsdpHystrixTargeter implements Targeter {
    ...
    public <T> T target(FeignClientFactoryBean factory, Feign.Builder feign, FeignContext context,
        ...
        MsdpFallbackFactory iyysoftFallbackFactory = new MsdpFallbackFactory(target);
        return (T) builder.target(target, iyysoftFallbackFactory);
    }
