 ...
 */
@Slf4j
public class MsdpWebResponseExceptionTranslator implements WebResponseExceptionTranslator {
    ...
    public ResponseEntity<OAuth2Exception> translate(Exception e) {
        ...
        if (ase != null) {
            //return handleOAuth2Exception(new NotBindException(ase.getMessage(), ase));
            return handleOAuth2Exception(null);
        }
    ...
    private ResponseEntity<OAuth2Exception> handleOAuth2Exception(OAuth2Exception e) {
        ...
        return new ResponseEntity<>(new MsdpAuth2Exception(e.getMessage(), e.getOAuth2ErrorCode()), headers,
                HttpStatus.valueOf(status));
