...
import com.iyysoft.msdp.common.security.util.AuthUtils;
...
@Slf4j
@Builder
public class OpenIdLoginSuccessHandler implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) {
        ...
        try {
            ...
            printWriter.append(objectMapper.writeValueAsString(new R<>(oAuth2AccessToken, REnum.CODE.OK)));
