 ...
 */
public class MsdpUserAuthenticationConverter implements UserAuthenticationConverter {
    ...
    public Authentication extractAuthentication(Map<String, ?> map) {
        if (map.containsKey(USERNAME)) {
            ...
            MsdpUser user = new MsdpUser(id, orgId, tenantId, username, mobile, mobile, N_A, true
