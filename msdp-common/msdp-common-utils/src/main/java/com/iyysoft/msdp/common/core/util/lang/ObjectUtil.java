...
public class ObjectUtil extends org.apache.commons.lang3.ObjectUtils {
    ...
    public static Double toDouble(final Object val) {
        ...
        try {
            return NumberUtil.toDouble(StringUtil.trim(val.toString()));
        } catch (Exception e) {
            return 0D;
        }
    }
...
//	}
    ...
    public static byte[] serializeFst(Object object) {
        ...
        long totalTime = System.currentTimeMillis() - beginTime;
        if (totalTime > 3000) {
            System.out.println("Fst serialize time: " + TimeUtil.formatDateAgo(totalTime));
        }
        return bytes;
    }
    ...
    public static Object unserializeFst(byte[] bytes) {
        ...
        long totalTime = System.currentTimeMillis() - beginTime;
        if (totalTime > 3000) {
            System.out.println("Fst unserialize time: " + TimeUtil.formatDateAgo(totalTime));
        }
        return object;
    }
