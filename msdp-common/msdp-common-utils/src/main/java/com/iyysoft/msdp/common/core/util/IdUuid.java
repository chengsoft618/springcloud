...
import com.iyysoft.msdp.common.core.util.lang.ObjectUtil;
...
public class IdUuid {
    ...
    public static String nextCode(String code) {
        if (code != null) {
            ...
            long num = ObjectUtil.toLong(numStr);
//			System.out.println("处理前："+str);
            str = prefix + com.iyysoft.msdp.common.core.util.lang.StringUtil.leftPad(String.valueOf(num + 1), numStr.length(), "0");
