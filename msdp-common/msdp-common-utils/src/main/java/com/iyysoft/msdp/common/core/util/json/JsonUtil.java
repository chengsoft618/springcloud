//package com.iyysoft.msdp.common.utils.json;
//
...
//                    } else {
//                        logger.warn("application.yml Not Configured json.class-type");
//                    }
//                } else {
//                    logger.warn("not found application.yml");
//                }
//            }
//
...
//                } else {
//                    logger.info("not foundjackson、gson、fastjson的依赖");
//                    throw new RuntimeException("not found jackson、gson、fastjson的依赖");
//                }
...
//                classType = "fastjson";
//            } else {
//                logger.info("not found jackson、gson、fastjson");
//                throw new RuntimeException("not found  jackson、gson、fastjson depends");
//            }
//
