...
//		if (staticFiles == null){
//			PropertiesUtil pl = PropertiesUtil.getInstance();
//			try{
//				staticFiles = StringUtil.split(pl.getProperty("web.staticFile"), ",");
//				staticFileExcludeUri = StringUtil.split(pl.getProperty("web.staticFileExcludeUri"), ",");
...
//		if (StringUtil.isNotBlank(params) && StringUtil.startsWith(params, "{")) {
