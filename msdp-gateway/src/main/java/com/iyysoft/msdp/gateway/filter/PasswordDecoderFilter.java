...
import com.iyysoft.msdp.gateway.utils.Pkcs7Encoder;
...
public class PasswordDecoderFilter extends AbstractGatewayFilterFactory {
    ...
    //@Value("${security.encode.key:iyysoft}")
    @Value("${security.encode.key:iyysoft1msdp1123}")
        ...
        return (exchange, chain) -> {
            ...
            if (StrUtil.isNotBlank(password)) {
                try {
                    ...
                    password = Pkcs7Encoder.decryptAES(password, encodeKey);
                } catch (Exception e) {
